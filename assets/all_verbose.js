 ...
 * Build: http://modernizr.com/download/#-fontface-borderradius-boxshadow-multiplebgs-textshadow-cssgradients-csstransitions-printshiv-mq-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
 */
;
    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (title && this.enabled) {
                ...
                $tip.remove().css({top: 0, left: 0, visibility: 'hidden', display: 'block', position: this.options.fixed? 'fixed' : 'absolute'}).prependTo(document.body);

                var pos = $.extend({}, this.options.fixed? this.$element.position() : this.$element.offset(), {
